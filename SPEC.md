...
Contexts will be able to reference and respond to transmissions from other contexts within the same program. `^` escalation and `*` propagation will carry state to named receivers.
